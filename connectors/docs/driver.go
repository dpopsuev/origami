// Package docs implements the HTTP documentation knowledge driver.
...
var _ skn.Driver = (*DocsDriver)(nil)
...
func (d *DocsDriver) Handles() knowledge.SourceKind {
	return knowledge.SourceKindDoc
}
