...
export function CircuitGraph({ events, nodeDescriptions }: Props) {
  ...
  return (
    <div className="h-full w-full relative" data-kami="component:circuit-graph" style={{ minHeight: 400 }}>
      <ReactFlow
        nodes={nodes}
        edges={edges}
        fitView
