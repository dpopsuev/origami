...
func TestVersionMatrix_ExactMatch(t *testing.T) {
	vm := knowledge.NewVersionMatrix(
		knowledge.VersionEntry{Version: "4.18", Branch: "release-4.18", DocsURL: "https://docs.example.com/4.18"},
		knowledge.VersionEntry{Version: "4.21", Branch: "release-4.21", DocsURL: "https://docs.example.com/4.21"},
	)
...
func TestVersionMatrix_PrefixMatch(t *testing.T) {
	vm := knowledge.NewVersionMatrix(
		knowledge.VersionEntry{Version: "4.21", Branch: "release-4.21"},
	)
...
func TestVersionMatrix_NoMatch(t *testing.T) {
	vm := knowledge.NewVersionMatrix(
		knowledge.VersionEntry{Version: "4.18", Branch: "release-4.18"},
	)
...
func TestVersionMatrix_NilMatrix(t *testing.T) {
	var vm *knowledge.VersionMatrix
	if entry := vm.Resolve("4.21"); entry != nil {
