...
func SummarizeSpec() metacal.ProbeSpec {
...
func ScoreSummarize(raw string) map[metacal.Dimension]float64 {
	...
	return map[metacal.Dimension]float64{
		metacal.DimEvidenceDepth: clamp(evidenceDepth),
