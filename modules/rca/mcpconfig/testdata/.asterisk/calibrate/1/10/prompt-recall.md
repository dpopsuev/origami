...
**Error message:**
```
ptp4l[67890.123]: failed to recover lock within 120 seconds after holdover
```

**Log snippet:**
```
2026-02-10T09:00:00Z ptp4l[67890.123]: failed to recover lock within 120 seconds
