...
**Error message:**
```
ptp4l[34567.890]: port 1: FREERUN state, holdover exceeded after 60s (expected 300s)
```

**Log snippet:**
```
2026-02-05T08:15:00Z ptp4l[34567.890]: port 1: FREERUN state, holdover exceeded after 60s
...
| Status | active |
| Occurrences | 1 |
| First seen | 2026-03-03T19:57:19Z |
| Last seen | 2026-03-03T19:57:19Z |
