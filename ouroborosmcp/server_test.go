...
func newTestServer(t *testing.T) *ouroborosmcp.Server {
	t.Helper()
	return ouroborosmcp.NewServer(t.TempDir())
}

func connectInMemory(t *testing.T, ctx context.Context, srv *ouroborosmcp.Server) *sdkmcp.ClientSession {
	t.Helper()
