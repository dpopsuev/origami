...
func TestDepGraph_TopologicalSort_Order(t *testing.T) {
	g := harvester.NewDepGraph(
		harvester.DepEdge{From: "rp-items", To: "jira-tickets"},
		harvester.DepEdge{From: "rp-items", To: "ci-logs"},
	)
...
func TestDepGraph_TopologicalSort_Cycle(t *testing.T) {
	g := harvester.NewDepGraph(
		harvester.DepEdge{From: "a", To: "b"},
		harvester.DepEdge{From: "b", To: "a"},
	)
...
func TestDepGraph_OrderSources(t *testing.T) {
	g := harvester.NewDepGraph(
		harvester.DepEdge{From: "base", To: "derived"},
	)
