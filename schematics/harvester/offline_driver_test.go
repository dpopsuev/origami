...
func TestOfflineFSDriver_Read(t *testing.T) {
	...
	driver := harvester.NewOfflineFSDriver(bundle, toolkit.SourceKindRepo)
...
func TestOfflineFSDriver_DocKind(t *testing.T) {
	ctx := context.Background()
	bundle := offlineBundle()
	driver := harvester.NewOfflineFSDriver(bundle, toolkit.SourceKindDoc)
...
func TestOfflineFSDriver_Handles(t *testing.T) {
	driver := harvester.NewOfflineFSDriver(nil, toolkit.SourceKindRepo)
