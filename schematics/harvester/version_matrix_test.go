...
func TestVersionMatrix_ExactMatch(t *testing.T) {
	vm := harvester.NewVersionMatrix(
		harvester.VersionEntry{Version: "4.18", Branch: "release-4.18", DocsURL: "https://docs.example.com/4.18"},
		harvester.VersionEntry{Version: "4.21", Branch: "release-4.21", DocsURL: "https://docs.example.com/4.21"},
	)
...
func TestVersionMatrix_PrefixMatch(t *testing.T) {
	vm := harvester.NewVersionMatrix(
		harvester.VersionEntry{Version: "4.21", Branch: "release-4.21"},
	)
...
func TestVersionMatrix_NoMatch(t *testing.T) {
	vm := harvester.NewVersionMatrix(
		harvester.VersionEntry{Version: "4.18", Branch: "release-4.18"},
	)
...
func TestVersionMatrix_NilMatrix(t *testing.T) {
	var vm *harvester.VersionMatrix
	if entry := vm.Resolve("4.21"); entry != nil {
