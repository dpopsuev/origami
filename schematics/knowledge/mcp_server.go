...
// RegisterTools adds the knowledge schematic's MCP tools to the given server.
...
// SynthesizeToolOpts configures the knowledge_synthesize MCP tool.
...
// RegisterSynthesizeTool adds the knowledge_synthesize MCP tool.
