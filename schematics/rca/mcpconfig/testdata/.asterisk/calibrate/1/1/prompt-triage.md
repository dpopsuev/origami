...
**Error message:**
```
ptp4l[12345.678]: port 1: FREERUN state, holdover exceeded after 60s (expected 300s)
```


**Log snippet:**
```
2026-02-01T10:00:00Z ptp4l[12345.678]: port 1: FREERUN state, holdover exceeded after 60s
