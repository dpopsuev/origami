...
**Error message:**
```
Expected PtpConfig 'cleanup-config' not to exist in namespace 'openshift-ptp' but it does
```

**Log snippet:**
```
2026-02-05T09:30:00Z Expected PtpConfig 'cleanup-config' not to exist
