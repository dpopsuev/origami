...
**Test name:** `OCP-49734 NTP sync validation`  
**Error message:**
```
chronyd[5678]: no selectable sources — all NTP servers unreachable
```

**Log snippet:**
```
2026-02-05T12:00:00Z chronyd[5678]: no selectable sources
