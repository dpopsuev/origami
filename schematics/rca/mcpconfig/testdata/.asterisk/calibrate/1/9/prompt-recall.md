...
**Error message:**
```
ptp4l[56789.012]: port 1: FREERUN state, holdover exceeded after 60s (expected 300s)
```

**Log snippet:**
```
2026-02-10T08:00:00Z ptp4l[56789.012]: port 1: FREERUN state, holdover exceeded after 60s
...
| Status | active |
| Occurrences | 1 |
| First seen | 2026-03-05T13:54:04Z |
| Last seen | 2026-03-05T13:54:04Z |
...
| Field | Value |
|-------|-------|
| RCA #4 | root cause from subagent-0 |
| Defect type | pb001 |
| Status | open |
| Affected versions |  |
...
| #3 | test-component | pb001 | root cause from subagent-1 |
| #4 | test-component | pb001 | root cause from subagent-0 |
| #5 | test-component | pb001 | root cause from subagent-0 |
| #6 | test-component | pb001 | root cause from subagent-1 |
